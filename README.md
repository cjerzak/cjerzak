...
* **Multiplication in Multimodal LLMs: Computation with Text, Image, and Audio Inputs (ACL Findings 2026)** – Samuel Balter, Ethan Jerzak, Connor T. Jerzak. _Investigates the computational limits of multimodal LLMs in exact multi-digit multiplication across text, image, and audio inputs._  [[PDF]](https://arxiv.org/abs/2604.18203) [[.bib]](https://connorjerzak.com/wp-content/uploads/2026/04/MultiplicationMultimodalBib.txt) [[Code]](https://github.com/cjerzak/llm-multimodal-math/) [![GitHub Repo stars](https://img.shields.io/github/stars/cjerzak/llm-multimodal-math?style=social)](https://github.com/cjerzak/llm-multimodal-math)
